      ...
      <div class="cp-media-shell">
        ...
        <div v-else-if="activeTab === 'stories'" class="cp-panel cp-stories-panel">
          ...
          <p v-else class="cp-empty-state">
            There are currently no success stories available for JSB3.
          </p>
        </div>
        ...
        <div v-else class="cp-panel cp-videos-panel">
          ...
          <p v-else class="cp-empty-state">
            There are currently no video updates available for JSB3. Check back later for new media highlights.
          </p>
        </div>
      </div>
    </div>
...
const storyCards = computed(() => jsb3Stories.filter((story) => story.pdfUrl || story.videoUrl));
