      ...
      <div class="container hero-inner">
        <div class="hero-content">
          ...
          <div class="hero-pills">
            <span class="hero-pill">Climate Promise 1, 2, …</span>
            <span class="hero-pill">Food Security 1, 2, …</span>
      ...
      <div class="container">
        ...
        <div class="grid grid-3">
          <article class="card feature-card">
            ...
            <p>
              <strong>Climate Promise 1, 2, …</strong> focus on reducing
          ...
          <article class="card feature-card">
            ...
            <p>
              <strong>Food Security 1, 2, …</strong> work with farmers,
